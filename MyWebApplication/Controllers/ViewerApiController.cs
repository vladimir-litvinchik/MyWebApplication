...
using MyWebApplication.Viewer.Common.Util.Comparator;
using MyWebApplication.Viewer.Cache;
...
namespace MyWebApplication.Controllers
{
    ...
    public class ViewerApiController : ApiController
    {
        ...
        /// </summary>
        protected static readonly ConcurrentDictionary<string, object> KeyLockerMap 
        ...
        [HttpGet]
        [Route("loadConfig")]
        public ViewerConfiguration LoadConfig() => globalConfiguration.Viewer;
        ...
        {
            GroupDocs.Viewer.Options.LoadOptions loadOptions 
                = new GroupDocs.Viewer.Options.LoadOptions
            {
                Password = password,
            };
